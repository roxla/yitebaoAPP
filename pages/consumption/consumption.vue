...
export default {
	...
	onLoad: function() {
		let opid = this.checkLogin('../consumption/consumption', 1);
	...
	methods: {
		...
		getAllData: function(type, stime, etime) {
			...
			uni.request({
				...
				fail: () => {
					this.reconnect('../consumption/consumption', 1);
				},
				complete: () => {
					this.$hideLoading();
				}
		...
		getUserData: function(data) {
			uni.request({
				url: this.apiServer + 'phoneServer/open/getWorkerData',
				method: 'POST',
				data: {
					workerNo: data
				},
		...
		getShopData: function(data) {
			uni.request({
				url: this.apiServer + 'phoneServer/open/getShopData',
				method: 'POST',
				data: {
					shopNo: data
				},
